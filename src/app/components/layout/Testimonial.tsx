...
const Testimonial: React.FC = () => {
  return (
    <div className="text-center mt-15 bg-[#D9D9D9]">
      ...
      <figure className="max-w-screen-md mx-auto text-center mt-4">
        ...
        <blockquote>
          <p className="text-3xxl italic font-medium text-black">
        ...
        <figcaption className="flex items-center justify-center mt-6 space-x-3 rtl:space-x-reverse">
          ...
          <div className="flex items-center divide-x-2 rtl:divide-x-reverse divide-gray-500 dark:divide-gray-700">
            <cite className="pe-3 font-medium text-black">Michael Gough</cite>
